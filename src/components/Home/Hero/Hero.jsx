...
export default function Hero() {
    return (
        <section className="relative overflow-hidden py-16 sm:py-24 bg-white dark:bg-base">
            {/* Background gradient */}
            ...
            <div className="max-w-7xl mx-auto px-6 grid items-center gap-12 lg:grid-cols-2">
                ...
                >
                    ...
                    >
                        Zyplo is a developer-focused project management tool with Kanban boards,
                        smart priorities, and lightning-fast navigation for teams that ship.
                    </motion.p>
