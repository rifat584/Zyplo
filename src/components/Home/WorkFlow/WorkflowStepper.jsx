...
const workflowSteps = [
  {
    ...
    content: {
      heading: "Plan",
      description: "Define your roadmap, create issues, and align the team before writing a single line of code.",
      badges: ["Roadmap view", "Issue tracking", "Spec editor"],
      previewTitle: "Backlog",
      previewItems: ["Q3 Performance Goals", "User Authentication Flow", "Database Schema Design"]
    }
  },
  {
    id: "build",
    ...
    content: {
      heading: "Build",
      description: "Move tasks across Kanban with live updates and no standup guesswork.",
      badges: ["WIP awareness", "Live updates", "Priority surfacing"],
      previewTitle: "In Progress Lane",
      previewItems: ["Fix OAuth callback", "Edge cache invalidation", "Command filter logic"]
    }
  },
  {
    id: "ship",
    ...
    content: {
      heading: "Ship",
      description: "Close sprint loops with checklist status, deployment readiness, and clean handoff.",
            ...
            {workflowSteps.map((step) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Text */}
                  <div>
                    <span className={`block text-base font-semibold ${isActive ? "text-gray-900" : "text-gray-500"}`}>
                      {step.stepNumber}. {step.title}
                    </span>
                    <span className={`block text-sm ${isActive ? "text-gray-700" : "text-gray-400"}`}>
                      {step.subtitle}
                    </span>
                  </div>
                </button>
