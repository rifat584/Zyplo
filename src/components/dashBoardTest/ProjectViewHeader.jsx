...
export default function ProjectViewHeader({
  ...
  const tabs = [
    { id: "board", label: "Board", href: `/dashBoardTest/w/${workspaceId}/p/${projectId}`, icon: Grid3X3 },
    { id: "list", label: "List", href: `/dashBoardTest/w/${workspaceId}/p/${projectId}/list`, icon: List },
    { id: "activity", label: "Activity", href: `/dashBoardTest/w/${workspaceId}/p/${projectId}/activity`, icon: Activity },
  ];
