    ...
    <header className="sticky top-0 z-40 flex h-16 w-full items-center justify-between border-b border-gray-200/80 bg-white/80 px-4 backdrop-blur-md dark:border-white/10 dark:bg-[#0B0F19]/80 sm:px-6 transition-colors duration-300">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden sm:flex items-center text-sm font-medium text-gray-500 dark:text-gray-400">
          <span className="hover:text-gray-900 dark:hover:text-white cursor-pointer transition-colors">Zyplo</span>
      ...
      <div className="flex items-center gap-3 sm:gap-5">
        ...
        {mounted && (
          ...
          >
            {theme === "light" ? <Moon size={16} /> : <Sun size={16} className="text-cyan-400" />}
          </button>
        )}
        ...
        {/* User Avatar */}
        <div className="h-8 w-8 cursor-pointer rounded-full bg-gradient-to-br from-blue-600 to-cyan-500 p-[2px] shadow-sm hover:scale-105 transition-transform">
