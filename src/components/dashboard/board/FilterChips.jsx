...
export default function FilterChips({
  ...
  const tabs = [
    { id: "board", href: `/dashboard/w/${workspaceId}/p/${projectId}`, icon: Grid3X3 },
    { id: "list", href: `/dashboard/w/${workspaceId}/p/${projectId}/list`, icon: List },
    { id: "activity", href: `/dashboard/w/${workspaceId}/p/${projectId}/activity`, icon: Activity },
  ];
