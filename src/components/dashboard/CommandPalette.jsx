  ...
  const actions = useMemo(() => {
    const base = [
      {
        id: "my-work",
        label: "Go to My Work",
        run: () => router.push("/dashboard/my-work"),
      },
      {
        id: "workspaces",
        label: "Go to Workspaces",
        run: () => router.push("/dashboard/workspaces"),
      },
    ];
    ...
    workspaces.forEach((workspace) => {
      base.push({
        ...
        run: () => router.push(`/dashboard/w/${workspace.id}`),
      });
    });
    ...
    projects.forEach((project) => {
      base.push({
        ...
        run: () => router.push(`/dashboard/w/${project.workspaceId}/p/${project.id}`),
      });
    });
