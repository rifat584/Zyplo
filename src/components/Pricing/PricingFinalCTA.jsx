          ...
          <div className="relative flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 gap-2 sm:flex sm:flex-wrap sm:justify-center">
              <StarBorder
                ...
                speed="4s"
                thickness={3}
                className="w-full sm:w-auto ring-1 ring-indigo-300/80 dark:ring-cyan-300/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
              >
              ...
              <Link
                href="/contact"
                className="inline-flex w-full items-center justify-center rounded-lg border border-slate-300 bg-white px-5 py-2.5 text-sm font-semibold text-slate-900 transition hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 sm:w-auto dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-800"
              >
                Talk to sales
              </Link>
            </div>
