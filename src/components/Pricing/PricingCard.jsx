  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        {plan.highlight && (
          <span className="text-center rounded-full border border-primary/20 bg-primary/10 px-3 py-1.5 text-xs font-semibold text-primary">
            Most Popular
          </span>
        )}
      </div>
      ...
      <Link href={"/login"}>
        <button
          className={`mt-8 w-full rounded-lg px-4 py-2.5 text-sm font-medium transition-colors ${
            plan.highlight
              ? "bg-linear-to-br from-indigo-500 to-cyan-400 text-white hover:bg-secondary/90"
