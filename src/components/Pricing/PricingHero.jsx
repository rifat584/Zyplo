...
export default function PricingHero() {
  return (
    <section className="relative overflow-hidden border-b border-border/70 py-12 dark:border-border/70 sm:py-16">
      ...
      <div className="pointer-events-none absolute left-1/2 top-2 h-44 w-[32rem] -translate-x-1/2 rounded-full bg-primary/18 blur-3xl dark:bg-indigo-400/20" />
      ...
      <div className="relative mx-auto max-w-6xl px-6 text-center">
        ...
        <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center rounded-lg border border-border bg-card/80 px-5 py-2.5 text-sm font-semibold text-slate-900 transition hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary dark:border-slate-700 dark:bg-card dark:text-slate-100 dark:hover:bg-surface"
          >
            Book a demo
          </Link>
        </div>
