...
function AuthCard({ title, subtitle, children }) {
  return (
    <Card className="relative w-full overflow-hidden rounded-2xl border border/40 bg-card/60 shadow-[0_20px_60px_-25px_rgba(15,23,42,0.25)] backdrop-blur-xl animate-in fade-in slide-in-from-bottom-3 duration-700 dark:border/10 dark:bg-card/35 dark:backdrop-blur-2xl dark:shadow-[0_20px_60px_-25px_rgba(0,0,0,0.65)]">
      ...
      <div className="relative z-10">
        <CardHeader className="space-y-2 pb-5 pt-7">
          ...
          <div>
            ...
            {subtitle ? <p className="mt-1 text-sm text-foreground dark:text-muted-foreground">{subtitle}</p> : null}
          </div>
        </CardHeader>
