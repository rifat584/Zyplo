...
export default function WorkspaceSettingsPage() {
  ...
  return (
    <section className="space-y-4 rounded-2xl border border-border bg-card p-4 dark:border/10">
      ...
      <div className="space-y-1">
        ...
        <input
          ...
          className="h-10 w-full rounded-xl border border-border bg-background px-3 text-sm outline-none dark:border/10 dark:bg-surface dark:text-foreground"
        />
      ...
      <div className="rounded-xl border border-border bg-muted/50 p-3 text-xs text-muted-foreground dark:border/10 dark:bg-surface/40">
        <p>Workspace ID: {workspaceId}</p>
        <p>Members: {workspace?.members?.length || 0}</p>
      </div>

      <div className="flex items-center justify-between rounded-xl border border-border p-4 dark:border/10">
        <div className="flex items-center gap-3">
          <span className="inline-flex size-8 items-center justify-center rounded-lg bg-card dark:bg-card/10">
