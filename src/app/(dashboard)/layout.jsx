          ...
          <main className="flex-1 overflow-y-auto overflow-x-hidden p-6 lg:p-8">
            ...
            <div className="mb-4 flex items-center justify-end gap-2 text-xs">
              ...
              <button
                ...
                className={`px-2 py-1 rounded border ${role === "admin" ? "bg-blue-50 border-blue-200 text-blue-700 dark:bg-blue-500/20 dark:border-blue-500/30 dark:text-cyan-400" : "border-gray-200 dark:border-white/10 dark:text-gray-400"}`}
              >
                Admin
              </button>
              <button
                onClick={() => setRole("user")}
                className={`px-2 py-1 rounded border ${role === "user" ? "bg-blue-50 border-blue-200 text-blue-700 dark:bg-blue-500/20 dark:border-blue-500/30 dark:text-cyan-400" : "border-gray-200 dark:border-white/10 dark:text-gray-400"}`}
              >
                User
              </button>
            </div>
