        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Link href={`/dashBoardTest/w/${workspaceId}/p/${project.id}/list`} className="text-sm text-slate-600 dark:text-slate-300">
                List
              </Link>
              <Link href={`/dashBoardTest/w/${workspaceId}/p/${project.id}/activity`} className="text-sm text-slate-600 dark:text-slate-300">
                Activity
              </Link>
            </div>
          </motion.div>
