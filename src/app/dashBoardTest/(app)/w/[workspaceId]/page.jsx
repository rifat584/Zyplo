...
import CreateProjectDialog from "@/components/dashBoardTest/dialogs/CreateProjectDialog";
import {
  getMyWorkStats,
...
import { Avatar } from "@/components/dashBoardTest/ui";
  ...
  return (
    <div className="space-y-5">
            ...
            {continueProject ? (
              <>
                ...
                <div className="mt-4 flex flex-wrap items-center gap-2">
                  <Link
                    href={`/dashBoardTest/w/${workspaceId}/p/${continueProject.id}`}
                  ...
                  <Link
                    href={`/dashBoardTest/w/${workspaceId}/p/${continueProject.id}/list`}
                ...
                <div className="mt-4 grid gap-3 border-t border-slate-200 pt-4 dark:border-white/10 md:grid-cols-[0.9fr_1.1fr]">
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2 pt-1">
                      <Link
                        href={`/dashBoardTest/w/${workspaceId}/members`}
                      ...
                      <Link
                        href={`/dashBoardTest/w/${workspaceId}/settings`}
                        className="rounded-lg border border-slate-200 px-2.5 py-1 text-xs text-slate-700 hover:bg-slate-50 dark:border-white/10 dark:text-slate-200 dark:hover:bg-slate-800"
                      >
                        Settings
                      </Link>
                    ...
                    {upcomingTasks.length > 0 ? (
                      <div className="space-y-2">
                        {upcomingTasks.map((task) => (
                          <Link
                            key={task.id}
                            href={`/dashBoardTest/w/${workspaceId}/p/${task.projectId}`}
                      ...
                      <div className="space-y-2">
                        {quickAccessProjects.map((project) => (
                          <Link
                            key={project.id}
                            href={`/dashBoardTest/w/${workspaceId}/p/${project.id}`}
      ...
      <CreateProjectDialog
        ...
        onCreated={(project) => router.push(`/dashBoardTest/w/${workspaceId}/p/${project.id}`)}
      />
    </div>
  );
}
