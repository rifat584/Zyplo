export default function About() {
  return (
    <div className="min-h-screen bg-surface dark:bg-background py-16 px-6 transition-colors duration-300">
      
      <div className="max-w-5xl mx-auto text-center">
        <h1 className="text-5xl font-bold text-foreground mb-6">About Zyplo</h1>
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-10 text-center">
        {/* Mission */}
        <div className="bg-card p-8 rounded-lg shadow-md dark:shadow-gray-800 hover:shadow-lg transition">
      ...
      <div className="max-w-5xl mx-auto mt-16 text-center">
        <h2 className="text-4xl font-bold text-foreground mb-6">Meet the Team</h2>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div className="bg-card rounded-lg shadow-md dark:shadow-gray-800 p-6 hover:shadow-lg transition">
            <h3 className="font-semibold text-foreground mb-2">Arif</h3>
            <p className="text-muted-foreground text-sm">CEO & Founder</p>
          </div>
          <div className="bg-card rounded-lg shadow-md dark:shadow-gray-800 p-6 hover:shadow-lg transition">
            <h3 className="font-semibold text-foreground mb-2">Lipi</h3>
            <p className="text-muted-foreground text-sm">Product Manager</p>
          </div>
          <div className="bg-card rounded-lg shadow-md dark:shadow-gray-800 p-6 hover:shadow-lg transition">
            <h3 className="font-semibold text-foreground mb-2">Sami</h3>
            <p className="text-muted-foreground text-sm">Lead Developer</p>
          </div>
          <div className="bg-card rounded-lg shadow-md dark:shadow-gray-800 p-6 hover:shadow-lg transition">
            <h3 className="font-semibold text-foreground mb-2">Nadia</h3>
