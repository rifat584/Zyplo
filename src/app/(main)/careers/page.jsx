  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-16">
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="p-6 border rounded-lg shadow hover:shadow-lg transition">
            ...
            <p className="text-sm text-gray-500 mb-4">Location: Remote / Hybrid</p>
            <button className="bg-linear-to-br from-indigo-500 to-cyan-400 px-4 py-2 rounded hover:bg-blue-900 transition">
              Apply Now
            </button>
          </div>
      ...
      <section className="text-center">
        ...
        <button className="bg-linear-to-br from-indigo-500 to-cyan-400 px-6 py-3 rounded-lg hover:bg-blue-900 transition">
